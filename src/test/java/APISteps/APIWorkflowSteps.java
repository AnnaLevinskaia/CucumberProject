...
public class APIWorkflowSteps {
    ...
    public void the_response_body_contains_key_and_value(String key, String value) {
        //arguments for key and value is coming from our feature
        response.then().assertThat().body(key, equalTo(value));
    }

    @Then("the employee id {string} is store as global to be used for other request")
    public void the_employee_id_employee_employee_id_is_store_as_global_to_be_used_for_other_request(String empId) {
    ...
    public void the_retrieved_data_at_object_should_match_with_the_data_used_for_creating_the_employee(String employeeObject, DataTable dataTable) {
        ...
        for(Map<String, String> map:expectedData){
            ...
            for (String key: keys //to compare
                 ) {
    ...
    @Given("a request is prepared for creating an employee with dynamic {string}, {string}, {string}, {string}, {string}, {string}, {string}")
    public void a_request_is_prepared_for_creating_an_employee_with_dynamic(String firstname, String lastname, String middlename,
